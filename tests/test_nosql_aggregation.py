...
class TestUnwindStage:
    ...
    def test_unwind_array_field(self, db: Database) -> None:
        ...
        col.insert_one({"title": "Post1", "tags": ["python", "coding"]})
        col.insert_one({"title": "Post2", "tags": ["javascript"]})
    ...
    def test_unwind_on_missing_field(self, db: Database) -> None:
        ...
        col.insert_one({"a": 1, "items": [10, 20]})
        col.insert_one({"a": 2})  # no "items" field
