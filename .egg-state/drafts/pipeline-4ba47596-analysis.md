...
**System context**: Repo has an initial commit with .gitignore, pyproject.toml (empty), and uv.lock (empty). uv is installed globally in the container. NOTE: The uv.lock file is empty/invalid — agents should delete it before running uv commands.
